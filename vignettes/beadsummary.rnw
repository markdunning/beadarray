...
The example BeadStudio output used in this section is available as a zip file that can be downloaded from {\\tt http://compbio.works/data/BeadStudioExample/AsuragenMAQC_BeadStudioOutput.zip}.
