...
plot(dist,inten, xlab="Distance", ylab="Intensity", ylim=ylim, xlim=range(0,1000), type="n", main=main, cex.main=2.1)
text(dist, inten, seq(1:length(inten)))
}


else{
plot(dist,inten, xlab="Distance", ylab="Intensity", ylim=ylim, xlim=range(0,1000), main=main,cex.main=2.1)
}
...
if(label){
plot(dist,2^inten, xlab="Distance", ylab="Intensity", ylim=ylim, xlim=range(0,1000), type="n", main=main,cex.main=2.1)
text(dist,2^inten, seq(1:length(inten)))
}

else{
plot(dist,2^inten, xlab="Distance", ylab="Intensity", ylim=ylim, xlim=range(0,1000), main=main,cex.main=2.1)
}
...
lm_xs = BLData$x[o, array] -min(arrx) 
lm_ys = BLData$y[o, array] - min(arry)
lm_ds = sqrt((lm_xs - xcentre)^2 + (lm_ys - ycentre)^2)
points(lm_ds, BLData$R[o, array], col="red", pch=3)
